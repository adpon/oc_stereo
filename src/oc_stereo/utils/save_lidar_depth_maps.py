...
from oc_stereo.dataloader.kitti import obj_utils, calib_utils, depth_map_utils
...
def main():
    ...
    # dataset = DatasetBuilder.build_kitti_dataset(DatasetBuilder.KITTI_TEST)
    data_split = dataset.data_split
    # dataset.use_same_calib()

    # Fill algorithm ('wavedata' or 'multiscale')
    # fill_type = 'wavedata'
    ...
    # out_depth_map_dir = 'outputs/depth_2_{}_same_calib'.format(fill_type)
    ...
    if os.path.isdir(out_depth_map_dir):
        pass
    else:
        os.makedirs(out_depth_map_dir)
